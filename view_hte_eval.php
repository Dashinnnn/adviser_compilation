...
try {
    $stmt = $conn->prepare("
        ...
        WHERE 
            student_id = ? AND document_type = 'eval_hte'
        ORDER BY
            upload_date DESC
        LIMIT 1
    ");
...
<head>
    ...
    <title>OJT Web Portal: Host Training Environment Evaluation Review</title>
        ...
        <div style="background-color: white; margin-top: 6rem; margin-left: 16rem; padding: 2rem;">
            ...
            <div class="content-holder">
                <div class="file-overview-holder">
                    <fieldset>
                        <legend>Host Training Environment Evaluation</legend>
                        <div class="overview-cont">
                            ...
                            <?php else: ?>
                                <p class="no-file-message">No Host Training Environment Evaluation document has been submitted.</p>
                            <?php endif; ?>
                        </div>
                    </fieldset>
                </div>
    ...
    <script>
        ...
        function viewMoa() {
            ...
            <?php else: ?>
                showCustomAlert({
                    title: 'Notice',
                    html: 'No Host Training Environment Evaluation document available to view.',
                    icon: 'info',
                    confirmText: 'OK'
                });
            <?php endif; ?>
        ...
        function updateStatus(documentId, status, remarks = null) {
            if (documentId === null) {
                showCustomAlert({
                    title: 'Error',
                    html: 'No Host Training Environment Evaluation document available to update.',
                    icon: 'error',
                    confirmText: 'OK'
                });
                return;
            ...
            showCustomAlert({
                title: 'Confirm',
                html: `You are about to mark this Host Training Environment Evaluation as <strong>${status}</strong>.`,

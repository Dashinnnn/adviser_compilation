        ...
        <div style="background-color: white; margin-top: 6rem; margin-left: 16rem; padding: 2rem;">
            ...
            <div class="page-header">
                <div class="page-title">
                    <h1 style="font-size: 16px;"><b>Working Student Internship Update</b></h1>
                </div>
            </div>
            <div style="padding: 50px;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        <a href="list_of_working_student_dtr.php" class="section-link">
                    ...
                    <div class="col-md-6 mb-4">
                        <a href="list_of_working_student_ie.php" class="section-link">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        <a href="list_of_working_student_wa.php" class="section-link">
                    ...
                    <!-- Photo Documentation -->
                    <div class="col-md-6 mb-4">
                        <a href="list_of_working_student_pd.php" class="section-link">
                            <div class="section inactive-section">
                                <div class="icon-container">

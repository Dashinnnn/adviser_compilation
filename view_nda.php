...
<head>
    ...
    <title>OJT Web Portal: NDA Review</title>
                ...
                <div class="file-overview-holder">
                    <fieldset>
                        ...
                        <div class="overview-cont">
                            ...
                            <?php else: ?>
                                <p class="no-file-message">No NDA document has been submitted.</p>
                            <?php endif; ?>
                        </div>
                    </fieldset>
                </div>
    ...
    <script>
        ...
        function viewMoa() {
            ...
            <?php else: ?>
                showCustomAlert({
                    title: 'Notice',
                    html: 'No NDA document available to view.',
                    icon: 'info',
                    confirmText: 'OK'
                });
            <?php endif; ?>
        ...
        function updateStatus(documentId, status, remarks = null) {
            if (documentId === null) {
                showCustomAlert({
                    title: 'Error',
                    html: 'No Non-Disclosure Agreement (NDA) document available to update.',
                    icon: 'error',
                    confirmText: 'OK'
                });
                return;
            ...
            showCustomAlert({
                title: 'Confirm',
                html: `You are about to mark this Non-Disclosure Agreement as <strong>${status}</strong>.`,

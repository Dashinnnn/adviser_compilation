    ...
    <script>
        ...
        function viewMoa() {
            ...
            <?php else: ?>
                showCustomAlert({
                    title: 'Notice',
                    html: 'No MOA document available to view.',
                    icon: 'info',
                    confirmText: 'OK'
                });
            <?php endif; ?>
        ...
        function updateStatus(documentId, status, remarks = null) {
            if (documentId === null) {
                showCustomAlert({
                    title: 'Error',
                    html: 'No Photo Documentation available to update.',
                    icon: 'error',
                    confirmText: 'OK'
                });
                return;
            ...
            showCustomAlert({
                title: 'Confirm',
                html: `You are about to mark this Photo Documentation as <strong>${status}</strong>.`,
                showCancelButton: true,
                confirmText: `Yes, ${status} it`,
                cancelText: 'Cancel',
                icon: 'warning',
                onConfirm: () => {
                    $.post('update_pd_status.php', {

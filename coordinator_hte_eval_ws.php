...
<body>
    ...
    <div class="content-wrap" style="height: 80%; width: 100%; margin: 0 auto;">
        <div style="background-color: white; margin-top: 6rem; margin-left: 16rem; padding: 2rem;">
            ...
            <div class="page-header">
                <div class="page-title"><br><h1 style="font-size: 16px;"><b>Evaluation Instrument for Host Training Establishment (HTE  )</b></h1><br><br></div>
            </div>
    ...
    <script>
        ...
        $(".view-profile").on("click", function() {
            ...
            window.location.href = "view_hte_eval.php?id=" + encodeURIComponent(studID);
        });
    </script>
</body>
</html>
...
<head>
    ...
    <title>OJT Web Portal: Internship Agreement Review</title>
    ...
    <script>
        ...
        function viewMoa() {
            ...
            <?php else: ?>
                showCustomAlert({
                    title: 'Notice',
                    html: 'No Internship Agreement document available to view.',
                    icon: 'info',
                    confirmText: 'OK'
                });
            <?php endif; ?>
        ...
        function updateStatus(documentId, status, remarks = null) {
            if (documentId === null) {
                showCustomAlert({
                    title: 'Error',
                    html: 'No Internship Agreement document available to update.',
                    icon: 'error',
                    confirmText: 'OK'
                });
                return;
            ...
            showCustomAlert({
                title: 'Confirm',
                html: `You are about to mark this Internship Agreement as <strong>${status}</strong>.`,

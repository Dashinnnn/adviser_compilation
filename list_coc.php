...
if (isset($_GET['export']) && in_array($_GET['export'], ['excel', 'csv', 'pdf']) && isset($_GET['section'])) {
    ...
    if ($_GET['export'] == 'excel') {
        ...
        $filename = "Trainees_COC_Section_{$section}.xlsx";
    ...
    if ($_GET['export'] == 'csv') {
        $filename = "Trainees_COC_Section_{$section}.csv";
    ...
    if ($_GET['export'] == 'pdf') {
        ...
        $pdf->SetTitle("Trainees COC Section {$section}");
        ...
        $filename = "Trainees_COC_Section_{$section}.pdf";

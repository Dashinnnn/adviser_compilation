...
if (!empty($assignedSection)) {
    $stmt = $conn->prepare("
        ...
        AND ed.document_type = 'eval_supervisor' 
...
// Fetch students for second section with submitted eval_hte documents
...
<body>
    ...
    <div class="content-wrap" style="height: 80%; width: 100%; margin: 0 auto;">
        <div style="background-color: white; margin-top: 6rem; margin-left: 16rem; padding: 2rem;">
            ...
            <div class="page-header">
                <div class="page-title"><br><h1 style="font-size: 16px;"><b>Evaluation Instrument for Training Supervisor</b></h1><br><br></div>
            </div>
                    ...
                    <div class="table-container">
                        <table class="trainee-table" id="table-first">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="5" style="text-align:center;">No students with submitted evaluations found in section <?php echo htmlspecialchars($assignedSection); ?>.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    ...
                    <div class="table-container">
                        <table class="trainee-table" id="table-second">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="5" style="text-align:center;">No students with submitted evaluations found in section <?php echo htmlspecialchars($secondAssignedSection); ?>.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
    ...
    <script>
        ...
        $(".view-profile").on("click", function() {
            ...
            window.location.href = "view_supervisor_eval.php?id=" + encodeURIComponent(studID);
        });
    </script>
</body>
</html>
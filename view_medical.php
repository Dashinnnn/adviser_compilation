                ...
                <div class="file-overview-holder">
                    <fieldset>
                        ...
                        <div class="overview-cont">
                            ...
                            <?php else: ?>
                                <p class="no-file-message">No medical clearance has been submitted.</p>
                            <?php endif; ?>
                        </div>
                    </fieldset>
                </div>
...
function viewMoa() {
    ...
    <?php else: ?>
        showCustomAlert({
            title: 'Notice',
            html: 'No medical document available to view.',
            icon: 'info',
            confirmText: 'OK'
        });
    <?php endif; ?>
...
function updateStatus(documentId, status, remarks = null) {
    if (documentId === null) {
        showCustomAlert({
            title: 'Error',
            html: 'No Medical Clearance document available to update.',
            icon: 'error',
            confirmText: 'OK'
        });
        return;
    ...
    showCustomAlert({
        title: 'Confirm',
        html: `You are about to mark this Medical Clearance as <strong>${status}</strong>.`,

    ...
    <script>
        ...
        function viewMoa() {
            ...
            <?php else: ?>
                showCustomAlert({
                    title: 'Notice',
                    html: 'No endorsement document available to view.',
                    icon: 'info',
                    confirmText: 'OK'
                });
            <?php endif; ?>
        ...
        function updateStatus(documentId, status, remarks = null) {
            if (documentId === null) {
                showCustomAlert({
                    title: 'Error',
                    html: 'No endorsement document available to update.',
                    icon: 'error',
                    confirmText: 'OK'
                });
                return;
            ...
            showCustomAlert({
                title: 'Confirm',
                html: `You are about to mark this Endorsement as <strong>${status}</strong>.`,

        ...
        <script>
            ...
            function viewMoa() {
                <?php if ($portfolio): ?>
                    ...
                    const iePreview = document.getElementById('portfolioPreview');
                ...
                <?php else: ?>
                    swal("Notice", "No portfolio document available to view.", "info");
                <?php endif; ?>
            }

            function updateStatus(documentId, status, remarks = null) {
                if (documentId === null) {
                    swal("Error", "No portfolio document available to update.", "error");
                    return;
                }
                swal({
                    title: `Are you sure?`,

...
if (!empty($assignedSection)) {
    $stmt = $conn->prepare("SELECT * FROM students_data WHERE stud_section = ? AND is_working_student = 'no'");
...
<html lang="en">
            ...
            <?php if (!empty($assignedSection)): ?>
                <div class="section-container">
                    <div class="page-header">
                        <div class="page-title"><h1 style="font-size: 16px"><b>Portfolio</b></h1></div>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.search-btn').on('click', function() {
                ...
                $('#table-' + tableId + ' tbody tr').each(function() {
                    var fullName = $(this).find('td:eq(3)').text().toLowerCase(); // Adjusted to Full Name (4th column)
        ...
        $(".view-profile").on("click", function() {
            ...
            window.location.href = "view_student_portfolio.php?id=" + encodeURIComponent(studID);
        });
    </script>
    </body>
</html> 